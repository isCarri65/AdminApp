...
export const HomePrincipal = () => {
  ...
  return (
    <div className={styles.mainContainer}>
      ...
      >
        <Button className={styles.buttonModal} onClick={handleOpenModal}>
          Crear Empresa
        </Button>
        <div className={styles.containerCompanys}>
          {empresas.map((empresa, index) => (
            <div
              ...
              onClick={() => handleCardCompany(empresa)}
              key={index}
              style={{ width: "100%" }}
            >
              <CompanyCard
      ...
      <ModalCreateCompany
        ...
        openModal={openModal}
      />
      <div className={openModalInfo ? styles.openModalInfo : styles.closeModalInfo}>
